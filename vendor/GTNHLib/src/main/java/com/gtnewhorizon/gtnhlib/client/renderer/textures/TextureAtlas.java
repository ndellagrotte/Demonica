...
public final class TextureAtlas {
    ...
    public boolean needsAnimationUpdate() {
        return Minecraft.getMinecraft().player.ticksExisted != lastTextureUpdate;
    }
    ...
    public FloatBuffer updateVBuffer() {
        lastTextureUpdate = Minecraft.getMinecraft().player.ticksExisted;
    ...
    public void uploadVBuffer(int location) {
        if (needsAnimationUpdate()) {
            GL20.glUniform2fv(location, updateVBuffer());
        }
    }
    ...
    public void uploadUVBuffer(int location) {
        if (needsAnimationUpdate()) {
            GL20.glUniform2fv(location, updateUVBuffer());
        }
    }
