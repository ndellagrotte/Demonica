...
public class PostProcessingManager {
    ...
    public static double viewX(double x) {
        return x - Minecraft.getMinecraft().getRenderManager().viewerPosX;
    }

    public static double viewY(double y) {
        return y - Minecraft.getMinecraft().getRenderManager().viewerPosY;
    }

    public static double viewZ(double z) {
        return z - Minecraft.getMinecraft().getRenderManager().viewerPosZ;
    }
