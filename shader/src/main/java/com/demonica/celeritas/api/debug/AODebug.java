...
public final class AODebug {
    private static final Logger LOGGER = LogManager.getLogger("DemonicaAODebug");
    private static final Map<String, Integer> COUNTS = new ConcurrentHashMap<>();
    private static final boolean OVERRIDE_ENABLED = Boolean.getBoolean("demonica.aoDebug");
