...
/**
 * Remaps desktop texture internal formats and pixel types to their GLES 3.2 equivalents.
 * Alpha-sized formats are promoted to RGBA on every context (drivers disagree on ALPHA sizing);
 * the remaining remaps only apply when a GLES context is detected.
 */
