...
/**
 * Per-GL-context state tracked by {@link GLStateManager}. The primary context is created lazily
 * on first access; worker contexts (parallel chunk building) get their own instance via
 * {@code enterWorkerContext()}. After a display-context migration the cached values here are
 * replayed onto the new context via {@link GLStateManager#replayStateToBackend()}.
 */
class GLContextState {
    /** Every BooleanStateStack owned by this context, for {@link GLStateManager#replayStateToBackend()}. */
    ...
    // GL_COLOR matrix changes (Actinium extension for ARB_imaging color matrix)
    public int colorMatrixGeneration;
    ...
    // draw framebuffer binding changes
    public int drawFramebufferGeneration;
    // Overlay color fed to the FFP fragment shader; part of fragmentGeneration tracking
    public float overlayR = 0.0f;
    public float overlayG = 0.0f;
    public float overlayB = 0.0f;
    public float overlayA = 0.0f;
    // Shader color override (Iris-style); tracked for FFP uniform upload
    ...
    public final int[] savedColorMatGen = new int[GLStateManager.MAX_ATTRIB_STACK_DEPTH];
    ...
    public final BooleanStateStack lineStippleState = track(new BooleanStateStack(GL11.GL_LINE_STIPPLE));
    public final BooleanStateStack pointSmoothState = track(new BooleanStateStack(GL11.GL_POINT_SMOOTH));
    public final BooleanStateStack polygonSmoothState = track(new BooleanStateStack(GL11.GL_POLYGON_SMOOTH));
    public final BooleanStateStack polygonStippleState = track(new BooleanStateStack(GL11.GL_POLYGON_STIPPLE));
    ...
    public final BooleanStateStack indexLogicOpState = track(new BooleanStateStack(GL11.GL_INDEX_LOGIC_OP));
    ...
    public final BooleanStateStack autoNormalState = track(new BooleanStateStack(GL11.GL_AUTO_NORMAL));
    public final BooleanStateStack map1Color4State = track(new BooleanStateStack(GL11.GL_MAP1_COLOR_4));
    public final BooleanStateStack map1IndexState = track(new BooleanStateStack(GL11.GL_MAP1_INDEX));
    public final BooleanStateStack map1NormalState = track(new BooleanStateStack(GL11.GL_MAP1_NORMAL));
    public final BooleanStateStack map1TextureCoord1State = track(new BooleanStateStack(GL11.GL_MAP1_TEXTURE_COORD_1));
    public final BooleanStateStack map1TextureCoord2State = track(new BooleanStateStack(GL11.GL_MAP1_TEXTURE_COORD_2));
    public final BooleanStateStack map1TextureCoord3State = track(new BooleanStateStack(GL11.GL_MAP1_TEXTURE_COORD_3));
    public final BooleanStateStack map1TextureCoord4State = track(new BooleanStateStack(GL11.GL_MAP1_TEXTURE_COORD_4));
    public final BooleanStateStack map1Vertex3State = track(new BooleanStateStack(GL11.GL_MAP1_VERTEX_3));
    public final BooleanStateStack map1Vertex4State = track(new BooleanStateStack(GL11.GL_MAP1_VERTEX_4));
    public final BooleanStateStack map2Color4State = track(new BooleanStateStack(GL11.GL_MAP2_COLOR_4));
    public final BooleanStateStack map2IndexState = track(new BooleanStateStack(GL11.GL_MAP2_INDEX));
    public final BooleanStateStack map2NormalState = track(new BooleanStateStack(GL11.GL_MAP2_NORMAL));
    public final BooleanStateStack map2TextureCoord1State = track(new BooleanStateStack(GL11.GL_MAP2_TEXTURE_COORD_1));
    public final BooleanStateStack map2TextureCoord2State = track(new BooleanStateStack(GL11.GL_MAP2_TEXTURE_COORD_2));
    public final BooleanStateStack map2TextureCoord3State = track(new BooleanStateStack(GL11.GL_MAP2_TEXTURE_COORD_3));
    public final BooleanStateStack map2TextureCoord4State = track(new BooleanStateStack(GL11.GL_MAP2_TEXTURE_COORD_4));
    public final BooleanStateStack map2Vertex3State = track(new BooleanStateStack(GL11.GL_MAP2_VERTEX_3));
    public final BooleanStateStack map2Vertex4State = track(new BooleanStateStack(GL11.GL_MAP2_VERTEX_4));
    ...
    public final Matrix4fStack colorMatrix = new Matrix4fStack(GLStateManager.MAX_COLOR_STACK_DEPTH);
