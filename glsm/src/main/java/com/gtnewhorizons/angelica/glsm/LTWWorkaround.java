...
/**
 * Workaround for the LTW (OpenLTW) mobile GL wrapper: a null-pixels BGRA glTexImage2D allocation
 * leaves the texture incomplete there, so a 1x1 RGBA texel is uploaded to force allocation.
 */
