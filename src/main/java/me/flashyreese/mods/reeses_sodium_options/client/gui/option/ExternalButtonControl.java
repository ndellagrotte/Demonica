...
/**
 * A non-stateful control which opens a separately owned screen when activated, mirroring the modern Sodium
 * external-button option. The control owns no value; the row renders a link-style label and forwards clicks to the
 * screen consumer.
 */
