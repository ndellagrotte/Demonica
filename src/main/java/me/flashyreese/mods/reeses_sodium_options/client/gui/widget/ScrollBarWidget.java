...
public class ScrollBarWidget extends BaseWidget {
    ...
    public boolean keyPressed(@NonNull KeyEvent event) {
        ...
        int newOffset = switch (event.key()) {
            case com.demonica.gui.rso.compat.KeyEvent.KEY_UP -> this.getOffset() - SCROLL_STEP;
            case com.demonica.gui.rso.compat.KeyEvent.KEY_DOWN -> this.getOffset() + SCROLL_STEP;
    ...
    public void updateNarration(@NonNull NarrationElementOutput builder) {
        ...
        builder.add(NarratedElementType.TITLE, com.demonica.gui.rso.compat.CommonComponents.optionNameValue(name, Component.literal(percentage + "%")));
        if (this.isFocused()) {
