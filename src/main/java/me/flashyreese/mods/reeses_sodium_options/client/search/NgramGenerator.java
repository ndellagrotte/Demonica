...
public final class NgramGenerator {
    ...
    private boolean isTokenChar(int cp) {
        ...
        if (cp <= 0x7F) {
            return isAllowedInIdentifier((char) cp);
        }
    ...
    /**
     * 1.12.2 equivalent of the modern
     * {@code Identifier.isAllowedInIdentifier} check: a resource-location
     * character is an ASCII lowercase letter, digit, underscore, dash or dot.
     */
    private static boolean isAllowedInIdentifier(char ch) {
