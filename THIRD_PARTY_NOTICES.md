...
| Reese's Sodium Options | https://github.com/FlashyReese/reeses-sodium-options, via Actinium's 1.12.2 port (`docs/rso-port.md` in Actinium) | `src/main/java/me/flashyreese/**`, `src/main/java/com/demonica/gui/rso/compat/`, `src/main/resources/assets/reeses-sodium-options/**` | MIT | yes |
