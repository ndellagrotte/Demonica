...
| GTNHLib (Actinium's 1.12.2 fork) | https://github.com/GTNewHorizons/GTNHLib | `GTNHLib/` | LGPL-3.0, plus file-level notices: the `bytebuf/` sources carry LWJGL's, `asm/ClassConstantPoolParser` carries ASM's | yes |
...
| LWJGL utility code | https://github.com/LWJGL/lwjgl3 | `glsm/.../glsm/GLDebug.java`, `GTNHLib/.../bytebuf/` | BSD-style LWJGL license, as in the file headers | yes |
